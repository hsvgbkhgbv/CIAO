...
from lbforaging.agents.A2CAgents_a9 import A2CAgentA9
...
class ForagingEnv(Env):
    ...
    def __init__(
        ...
        with_gnn_shuffle=False,
        collapsed=False,
        exclude_A2Cagent=False,
        # NOTE: JIANHONG CHANGE 23/03/2024
        predefined_agent_types=None
    ):
        self.n_agents = 1
        ...
        # NOTE: JIANHONG CHANGE 04/01/2024
        self.exclude_A2Cagent = exclude_A2Cagent
        # NOTE: JIANHONG CHANGE 23/03/2024
        self.predefined_agent_types = predefined_agent_types
    ...
    def agent_type_selector(self):
        ...
        # NOTE: JIANHONG CHANGE 04/01/2024
        if self.exclude_A2Cagent:
            agent_types = ["H8", "H7", "H6", "H5", "H1", "H2", "H3", "H4"]
        # NOTE: JIANHONG CHANGE 23/03/2024
        if self.predefined_agent_types:
            agent_types = self.predefined_agent_types
        ...
        if agent_type == "H1":
            ...
            if len(self.players)== 9:
                return agent_type, A2CAgentA9(a2c_index)
            else:
